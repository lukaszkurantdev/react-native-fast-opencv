...
jsi::Value PointFactory::get(jsi::Runtime& runtime, const jsi::PropNameID& propNameId) {
    ...
    case hashString("create", 6): {
      return jsi::Function::createFromHostFunction(
         ...
         [](jsi::Runtime& rt, const jsi::Value& thisArg, const jsi::Value* args, size_t count) -> jsi::Value {
           ...
           return FOCV_JsiObject::wrap(rt, "point", std::make_shared<decltype(object)>(object));
         }
      );
    } break;
  }
...
std::vector<jsi::PropNameID> PointFactory::getPropertyNames(jsi::Runtime& rt) {
