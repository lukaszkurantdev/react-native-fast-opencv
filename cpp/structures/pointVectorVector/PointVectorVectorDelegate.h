...
#ifndef PointVectorVectorDelegate_h
#define PointVectorVectorDelegate_h

using namespace facebook;

class PointVectorVectorDelegate : public TypeDelegate {
public:
...
#endif // !PointVectorVectorDelegate_h
