...
jsi::Value PointVectorVectorFactory::get(jsi::Runtime& runtime, const jsi::PropNameID& propNameId) {
    ...
    case hashString("create", 6): {
      return jsi::Function::createFromHostFunction(
         ...
         [](jsi::Runtime& rt, const jsi::Value& thisArg, const jsi::Value* args, size_t count) -> jsi::Value {
           ...
           return FOCV_JsiObject::wrap(rt, "point_vector_vector", std::make_shared<decltype(vec)>(vec));
         }
      );
    } break;
  }
...
std::vector<jsi::PropNameID> PointVectorVectorFactory::getPropertyNames(jsi::Runtime& rt) {
