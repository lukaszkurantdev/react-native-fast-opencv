...
jsi::Value RectVectorFactory::get(jsi::Runtime& runtime, const jsi::PropNameID& propNameId) {
    ...
    case hashString("create", 6): {
      return jsi::Function::createFromHostFunction(
         ...
         [](jsi::Runtime& rt, const jsi::Value& thisArg, const jsi::Value* args, size_t count) -> jsi::Value {
           ...
           return FOCV_JsiObject::wrap(rt, "rect_vector", std::make_shared<decltype(vec)>(vec));
         }
      );
    } break;
  }
...
std::vector<jsi::PropNameID> RectVectorFactory::getPropertyNames(jsi::Runtime& rt) {
