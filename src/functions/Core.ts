...
export type Core = {
   ...
   * @param mask optional operation mask, 8-bit single channel array, that specifies elements of the output array to be changed.
   */
  bitwise_and(src1: Mat, src2: Mat | Scalar, dst: Mat, mask?: Mat): void;
  bitwise_and(src1: Scalar, src2: Mat, dst: Mat, mask?: Mat): void;
  /**
   ...
   * @param mask optional operation mask, 8-bit single channel array, that specifies elements of the output array to be changed.
   */
  bitwise_or(src1: Mat, src2: Mat | Scalar, dst: Mat, mask?: Mat): void;
  bitwise_or(src1: Scalar, src2: Mat, dst: Mat, mask?: Mat): void;
  /**
   ...
   * @param mask optional operation mask, 8-bit single channel array, that specifies elements of the output array to be changed.
   */
  bitwise_xor(src1: Mat, src2: Mat | Scalar, dst: Mat, mask?: Mat): void;
  bitwise_xor(src1: Scalar, src2: Mat, dst: Mat, mask?: Mat): void;
   ...
   */
  compare(src1: Mat, src2: Mat | Scalar, dst: Mat, cmpop: CmpTypes): void;
  compare(src1: Scalar, src2: Mat, dst: Mat, cmpop: CmpTypes): void;
   ...
   */
  crop(src: Mat, dst: Mat, roi: Rect): void;
  ...
  magnitude(x: MatVector, y: MatVector, magnitude: Mat): void;
   ...
   */
  Mahalanobis(v1: Mat, v2: Mat, icovar: Mat): void;
  Mahalanobis(v1: MatVector, v2: MatVector, icovar: Mat): void;
   ...
   */
  phase(x: Mat, y: Mat, angle: Mat, angleInDegrees: boolean): void;
  phase(x: MatVector, y: MatVector, angle: Mat, angleInDegrees: boolean): void;
   ...
   */
  PSNR(src1: Mat, src2: Mat, R: number): { psnr: number };
   ...
   */
  rotate(src: Mat, dst: Mat, code: RotateFlags): void;
   ...
   */
  solvePoly(src: Mat, dst: Mat, maxIters: number): { value: number };
